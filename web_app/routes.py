...
from web_app.forms import (RegistrationForm, LoginForm, UpdateAccountForm, PostForm, RequestResetForm, ResetPasswordForm)
...
def reset_token(token):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash('Your account password has been updated and you can login now!', 'success')
        return redirect(url_for('login'))
